...
def render() -> None:
    ...
    st.bar_chart(df.set_index("tipo"), color="#30d98c", height=260)
    ...
    with col1:
        ...
        st.line_chart(dfm.set_index("mes"), color="#7cb7ff", height=220)
    with col2:
        ...
        st.bar_chart(dff.set_index("tipo"), color="#f5b944", height=220)
